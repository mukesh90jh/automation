...
public class DynamicTable {
	...
	@Test(priority=2)
	public void readParticularCellValue() {
	...
	@Test(priority=3)
	public void printrowcolumnofvalue() {
		...
		for (int row=0; row<rows_count; row++){
			...
			int columns_count = Columns_row.size();
			for (int column=0; column<columns_count; column++){
				if(Columns_row.get(column).getText().equals("6")){
					System.out.println("rowNum:"+row+">>"+"colNum:"+column);
